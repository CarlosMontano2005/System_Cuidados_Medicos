 ...
 * @author pc
 */
public class FrmIndicacionesMedicas extends javax.swing.JFrame {

    /**
     * Creates new form FrmTallasPacientes
     */
    public FrmIndicacionesMedicas() {
        initComponents();
         //aliniar al centro
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Indicaciones Medicas");
        ...
        PnlContenedor.add(BtnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 60, 130, 50));
        ...
        PnlContenedor.add(BtnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 120, 130, 50));
        ...
        PnlContenedor.add(BtnLimpiarCampos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 180, 160, 50));
...
//               next.setVisible(true);
 ...
 int xMouse, yMouse;
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FrmIndicacionesMedicas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmIndicacionesMedicas().setVisible(true);
            }
        });
    }
