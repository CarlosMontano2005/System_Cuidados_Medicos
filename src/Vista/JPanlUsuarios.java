 ...
 * @author pc
 */
public class JPanlUsuarios extends javax.swing.JPanel {

    /**
     * Creates new form JPanlUsuarios
     */
    public JPanlUsuarios() {
    ...
    private void initComponents() {
        ...
        ImgUsuario = new jroundborder.JLabelRound();
        ...
        ImgUsuario.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Recursos/woman.jpg"))); // NOI18N
        add(ImgUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 100, 200, 200));
        ...
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 320, -1, -1));

        jLabel5.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Nombre usuario");
        add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, -1, -1));

        jLabel8.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(0, 0, 0));
        jLabel8.setText("Empleado");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 320, -1, -1));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Tipo de usuario");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, -1, -1));

        jLabel13.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(0, 0, 0));
        jLabel13.setText("Estado del usuario");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 440, -1, -1));
        ...
        add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 270, 30));
        ...
        add(jComboBox6, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 340, 270, 30));

        jTextField4.setBackground(new java.awt.Color(236, 245, 250));
        jTextField4.setFont(new java.awt.Font("Times New Roman", 0, 16)); // NOI18N
        jTextField4.setForeground(new java.awt.Color(0, 0, 0));
        add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 400, 270, 30));
        ...
        add(jComboBox7, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 460, 270, 30));
        ...
        add(jComboBox8, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 400, 270, 30));
    ...
    private jroundborder.JLabelRound ImgUsuario;
