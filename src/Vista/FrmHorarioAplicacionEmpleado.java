 ...
 * @author pc
 */
public class FrmHorarioAplicacionEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form FrmTallasPacientes
     */
    public FrmHorarioAplicacionEmpleado() {
        initComponents();
         //aliniar al centro
    ...
    private void initComponents() {
        ...
        PnlContenedor.add(BtnAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 10, 130, 50));
        ...
        PnlContenedor.add(BtnActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 130, 50));
        ...
        PnlContenedor.add(BtnLimpiarCampos1, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 170, 160, 50));
        ...
        PnlContenedor.add(jComboBox5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 320, 30));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Plan");
        PnlContenedor.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, -1, -1));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 16)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Dias");
        PnlContenedor.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, -1, -1));
        ...
        PnlContenedor.add(jComboBox6, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 160, 320, 30));
...
//               next.setVisible(true);
 ...
 int xMouse, yMouse;
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FrmHorarioAplicacionEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmHorarioAplicacionEmpleado().setVisible(true);
            }
        });
    }
