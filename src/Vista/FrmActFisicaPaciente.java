 ...
 * @author pc
 */
public class FrmActFisicaPaciente extends javax.swing.JFrame {

    /**
     * Creates new form FrmTallasPacientes
     */
    public FrmActFisicaPaciente() {
        initComponents();
         //aliniar al centro
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Tipo de actividad fisica");
...
//               next.setVisible(true);
 ...
 int xMouse, yMouse;
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FrmActFisicaPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmActFisicaPaciente().setVisible(true);
            }
        });
    }
