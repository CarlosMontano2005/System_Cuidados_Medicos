 ...
 * @author pc
 */
public class FrmTelefonoEmpleado extends javax.swing.JFrame {
...
//               next.setVisible(true);
 ...
 int xMouse, yMouse;
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FrmTelefonoEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTelefonoEmpleado().setVisible(true);
            }
        });
    }
