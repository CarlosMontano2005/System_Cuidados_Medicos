 ...
 * @author pc
 */
public class FrmAVDpacientes extends javax.swing.JFrame {

    /**
     * Creates new form FrmTallasPacientes
     */
    public FrmAVDpacientes() {
        initComponents();
         //aliniar al centro
...
//               next.setVisible(true);
 ...
 int xMouse, yMouse;
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FrmAVDpacientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
 ...
 try {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmAVDpacientes().setVisible(true);
            }
        });
    }
